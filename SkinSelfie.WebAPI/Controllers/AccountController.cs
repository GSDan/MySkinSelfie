...
using SkinSelfie.WebAPI.Results;
using System;
...
namespace SkinSelfie.WebAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var callbackUrl = Url.Link("GetConfirmEmail", new { UserId = user.Id, Code = code });

            await ServerUtils.SendEmail(user.Email, user.UserName, "Confirm your Skin Selfie account",
                "Please confirm your account by clicking this link: <a href=\""
                + callbackUrl + "\">confirm account</a>.");
        ...
        public async Task<IHttpActionResult> ResendConfirmation()
        {
            string userId = User.Identity.GetUserId();

            string code = await UserManager.GenerateEmailConfirmationTokenAsync(userId);

            var callbackUrl = Url.Link("GetConfirmEmail", new { UserId = userId, Code = code });

            await ServerUtils.SendEmail(User.Identity.GetUserName(), User.Identity.Name, "Confirm your Skin Selfie account",
                "Please confirm your account by clicking this link: <a href=\""
                + callbackUrl + "\">confirm account</a>.");
